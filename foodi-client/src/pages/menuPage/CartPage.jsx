            ...
            <div className=" bg-gradient-to-r from-0% from-[#FAFAFA] to-[#FCFCFC] to-100%">
                <div className="py-28 flex flex-col items-center justify-center">
                    ...
                    <div className=" text-center px-4 space-y-7">
                        <h2 className="md:text-5xl text-4xl font-bold md:leading-snug leading-snug tb">
                                ...
                                <tbody className="tb">
                                    {cart.map((item, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <button
                                                    className="btn btn-xs bg-white text-black hover:text-white"
                                                ...
                                                <input
                                                    ...
                                                    className="w-10 mx-2 text-center text-black bg-white overflow-hidden appearance-none"
                                                />
                                                <button
                                                    className="btn btn-xs  bg-white text-black hover:text-white"
